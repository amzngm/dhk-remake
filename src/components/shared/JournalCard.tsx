...
export default function JournalCard({
  ...
  return (
    ...
    >
      ...
      <div className="bottom-0 z-10 absolute flex justify-between items-start gap-6 w-full bg-bg normal-case leading-snug tracking-wide p-2">
        ...
        <div className="space-y-8 w-3/4">
          ...
          <div className="max-lg:hidden grid lg:grid-rows-[0fr] lg:group-hover:grid-rows-[1fr] transition-all duration-350 ease-out me-4 mb-4">
            {previewText && (
              <p className="opacity-0 lg:group-hover:opacity-40 line-clamp-5 text-balance transition-all translate-y-2 lg:group-hover:translate-y-0 duration-500 ease-out delay-200">
                {previewText}
              </p>
            )}
          </div>
